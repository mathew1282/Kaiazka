...
function renderSzablony() {
    ...
    appState.szablony.forEach((template, index) => {
        ...
        <tr>
            ...
            <td><button class="btn-primary" onclick="editTemplate(${index})">Edytuj</button></td>
            <td><button class="btn-danger" onclick="removeTemplate(${index})">Usuń</button></td>
        </tr>`;
    });
    ...
    <div id="templateModal" class="modal-overlay" style="display:none;">
        <div class="modal">
            ...
            <div class="modal-actions">
                <button class="btn-success" onclick="saveTemplate()">Zapisz</button>
...
async function saveTemplate() {
    ...
    if (!nazwa) return alert("Podaj nazwę szablonu");
...
async function editTemplate(index) {
    ...
    const t = appState.szablony[index];
    document.getElementById("templateName").value = t.nazwa;
    document.getElementById("templateText").value = t.tresc;
    document.getElementById("templateModal").style.display = "flex";
}
